package com.therian.oc.aaa.data.model.draw
...
open class DrawableDraw(
    override var drawable: Drawable,
    private val path: String,
    private val drawWidth: Int? = null,
    private val drawHeight: Int? = null
) : Draw() {
    ...
    override val width: Int
        get() = drawWidth ?: drawable.intrinsicWidth
    override val height: Int
        get() = drawHeight ?: drawable.intrinsicHeight
